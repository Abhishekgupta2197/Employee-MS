...
namespace Employee_Management.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmployeeRepository employeeRepository)
        {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string ReturnUrl) 
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    HttpContext.Session.SetString("AdminSession","Abhishek");
                    ...
                    Employee employee = _employeeRepository.GetAllEmployee().FirstOrDefault(x => x.Email == model.Name && x.Password == model.Password);
                    if (employee != null) {
